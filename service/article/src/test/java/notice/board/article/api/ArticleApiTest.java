package notice.board.article.api;
...
public class ArticleApiTest {
    ...
    @Test
    void readTest() {
        ArticleResponse response = read(329187655796195328L);
        System.out.println("response = " + response);
    }
    ...
    void deleteTest() {
        restClient.delete()
                .uri("/v1/articles/{articleId}", 329187655796195328L)
                .retrieve();
    }
