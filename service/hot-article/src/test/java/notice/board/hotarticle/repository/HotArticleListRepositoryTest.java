package notice.board.hotarticle.repository;
...
class HotArticleListRepositoryTest {
    ...
    void addTest() throws InterruptedException {
        // given
        LocalDateTime time = LocalDateTime.of(2026, 7, 7, 0, 0);
        long limit = 3;
        ...
        // then
        List<Long> articleIds = hotArticleListRepository.readAll("20260707");
        ...
        assertThat(hotArticleListRepository.readAll("20260707")).isEmpty();
    }
}