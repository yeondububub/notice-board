...
public class CommentApiTest {
    ...
    void read() {
        CommentResponse response = restClient.get()
                .uri("/v1/comments/{commentId}", 329891468878786560L)
                .retrieve()
                .body(CommentResponse.class);
    ...
    void delete() {
        restClient.delete()
                .uri("/v1/comments/{commentId}", 329888417184219136L)
                .retrieve()
                .toBodilessEntity();
    }
